...
SELECT DISTINCT
    ...
    FORMA_COBRO,
    MARCA_FINANCIADA,
    VALOR_PRIMA_ENDOSO_CANCELACION,
    VALOR_IMPUESTO_ENDOSO_CANCELACION,
    VALOR_TOTAL_ENDOSO_CANCELACION,
    VALOR_PRIMA_ENDOSO_CERO,
    AGRUPACION_DESCRIPCION_ENDOSO_CANCELACION,
    FECHA_PROCESO,
    ALTURA_POLIZA,
    MARCA_CANCELACION_DEFINITIVA,
    FECHA_CANCELACION_DEF,
    VALOR_PRIMA_RECIBIDA_HASTA_CANCELACION,
    VALOR_TOTAL_PRIMA_RECIBIDA,
    PERIODO_FACTURACION,
    COD_TIPO_CANCELACION,
    CLASIFICACION_GENERAL_CANCELACIONES
FROM 
