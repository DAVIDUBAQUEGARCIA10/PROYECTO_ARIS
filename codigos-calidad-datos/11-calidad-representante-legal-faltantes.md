# Calidad de Datos: Representante Legal - Campos Faltantes

## Descripción
Identifica clientes jurídicos con productos vigentes que tienen **TIP_DOC_REPRESENTANTE_LEGAL NULL** en ARIS. Intenta complementar con datos de Davivienda.

## Diferencia con Archivo A
- **Archivo A**: Todos los clientes vigentes
- **Archivo B**: SOLO clientes sin representante legal registrado en ARIS
...
WHERE b.KEY_ID_REPRESENTANTE_LEGAL IS NULL;
```
