# Calidad de Datos: Fecha de Nacimiento - Revisoria PN

## Descripción
Extrae fecha de nacimiento de personas naturales en revisoria fiscal con validación de rango (1901-actual). Compara ARIS vs Davivienda.
...
SELECT b.TIPO_DOCUMENTO, b.KEY_ID, cn.FEC_NACIMIENTO, d.FECHA_NACIMIENTO_DAV
FROM base b
LEFT JOIN clientes_naturales cn ON b.TIPO_DOCUMENTO = cn.TIPO_DOCUMENTO AND b.KEY_ID = cn.KEY_ID
