# Cliente Juridico - Capitalizadora
...
```
CREATE OR REPLACE TABLE `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.segmentacion_capitalizadora_pj_cliente` AS 
...
LEFT JOIN `sb-ecosistemaanalitico-lago.seguros_bolivar.t_clientes_juridicos` cn
...
Archivo Original: Cliente Juridico - Capitalizadora
