# Cliente Natural - Comerciales Bolivar
...
```
-- =====================================================================
-- Tabla final: segmentacion_comerciales_pn_cliente
-- Alcance:
...
CREATE OR REPLACE TABLE
  `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.segmentacion_comerciales_pn_cliente` AS
...
polizas AS (
  ...
  WHERE DATE(p.FECHA_FIN_POLIZA) >= DATE_SUB(CURRENT_DATE(), INTERVAL 12 MONTH) -- vigentes desde hace 12 meses atras sin contar el mes actual
    AND SAFE_CAST(p.CODIGO_COMPANIA AS INT64) = 3
    and CODIGO_RAMO_EMISION != 310               -- compañía 3
...
Archivo Original: Cliente Natural - Comerciales Bolivar
