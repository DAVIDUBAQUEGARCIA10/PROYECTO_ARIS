# Jurisdicción - Comerciales Bolivar
...
WHERE percentil_rank_r < 95
and VALOR_TOTAL_RECAUDO >= 0 
and percentil_rank_s < 95
...
Archivo Original: Jurisdicción - Comerciales Bolivar
