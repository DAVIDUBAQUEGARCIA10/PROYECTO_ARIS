...
```
CREATE OR REPLACE TABLE `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.segmentacion_comerciales_prodcuto` AS 
...
Archivo Original: Producto - Comerciales Bolivar
