...
SELECT
  ...
  -- ✅ SOLO VISUAL: último día del mes anterior a la fecha de calificación
  LAST_DAY(DATE_SUB(sf.Fecha_Calificacion_DATE, INTERVAL 1 MONTH), MONTH) AS FECHA_CALIFICACION_POSTERIOS,

  -- ✅ SOLO VISUAL: último día del mes anterior a la fecha anterior
...
Archivo Original: Incremento_score_de_riesgo
