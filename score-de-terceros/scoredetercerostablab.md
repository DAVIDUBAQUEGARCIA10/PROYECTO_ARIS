...
```
CREATE OR REPLACE TABLE sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.Score_de_terceros_final AS
...
Archivo Original: Score_de_terceros_Tabla_B
