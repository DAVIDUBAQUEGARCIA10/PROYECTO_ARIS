...
INSERT INTO `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.cap_0013_prod` (
  FECHA_TRANSACCION,
  NUMERO_TITULO,
...
base AS (
  ...
  AND m.FECHA_TRANSACCION >= '2026-03-01'
),
...
WHERE rn = 1
  AND NOT EXISTS (
    SELECT 1
    FROM `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.cap_0013_prod` t
...
Archivo Original: cap_0013_prod
