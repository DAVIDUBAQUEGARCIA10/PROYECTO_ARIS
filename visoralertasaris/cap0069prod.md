...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.cap_069_prod
...
WHERE  m.DESCRIPCION_TIPO_MOVIMIENTO IN (
    ...
    ) AND m.FECHA_TRANSACCION >= '2026-03-01'  AND m.VALOR_TRANSACCION > 1000000 AND t2.PUBLICAMENTE_EXPUESTA = "S"
  AND NOT EXISTS (
    SELECT 1
    FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.cap_069_prod t
...
Archivo Original: cap_0069_prod
