...
```
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0010_prod  (
  CODIGO_COMPANIA,
  NUMERO_POLIZA,
...
WHERE
  ...
  AND nivel_riesgo_nacionalidad in ('Alto',"Medio")
  AND NOT EXISTS (
    SELECT 1
    FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0010_prod  t
...
Archivo Original: com_0010_prod
