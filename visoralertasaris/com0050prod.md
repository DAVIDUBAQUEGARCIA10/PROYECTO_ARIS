...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0050_prod
SELECT DISTINCT
    p.CODIGO_COMPANIA,
...
WHERE 
    p.FECHA_EMISION_ENDOSO > '2026-03-01' 
    AND p.FECHA_INICIO_ENDOSO > '2026-03-01'
    ...
    AND NOT EXISTS (
        SELECT 1
        FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0050_prod t
        WHERE 
...
Archivo Original: com_0050_prod
