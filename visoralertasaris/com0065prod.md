...
```
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0065_prod
(
...
WITH SiniestrosConFila AS (
    ...
    WHERE 
        ...
        AND CODIGO_COMPANIA = 3  -- Compañía específica
...
WHERE 
    ...
    AND NOT EXISTS (
        ...
        SELECT 1
        FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0065_prod existing
...
Archivo Original: com_0065_prod
