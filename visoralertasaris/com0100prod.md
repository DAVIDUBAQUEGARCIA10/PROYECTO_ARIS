...
```
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0100_prod (
    CODIGO_COMPANIA, 
...
WITH SiniestrosPorMes AS (
    ...
    WHERE 
        DATE(FECHA_SUSCRIPCION) >= '2026-03-01'
...
WHERE 
    ...
    AND NOT EXISTS (
        SELECT 1
        FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0100_prod r
        ...
        AND r.FECHA_SINIESTRO = SiniestrosPorMes.FECHA_SINIESTRO
                AND r.LIQUIDADO_BOLIVAR = SiniestrosPorMes.LIQUIDADO_BOLIVAR
    )
ORDER BY 
...
Archivo Original: com_0100_prod
