...
```
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0105_prod (
  TIPO_DOCUMENTO,
  KEY_ID,
  CODIGO_RAMO_EMISION,
  CODIGO_PRODUCTO,
...
WHERE d.diferencia_ingresos > 5000000
  ...
  AND NOT EXISTS (
    SELECT 1
    FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0105_prod t
...
Archivo Original: com_0105_prod
