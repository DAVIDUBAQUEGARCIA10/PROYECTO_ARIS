...
```
INSERT INTO `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0106_prod`
(
    CODIGO_COMPANIA,
    NUMERO_POLIZA,
...
AND NOT EXISTS (
    SELECT 1
    FROM `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0106_prod` r
...
Archivo Original: com_0106_prod
