...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0115_prod (
...
# Evitar duplicados ya presentes en la tabla
  AND NOT EXISTS (
    SELECT 1
    FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0115_prod existing
...
Archivo Original: com_0115_prod
