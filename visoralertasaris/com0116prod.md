...
```
-- Insertar solo los registros nuevos en la tabla COM_0116_VISOR_REPO
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0116_prod
(
...
-- Seleccionar solo los registros nuevos que no están en la tabla COM_0116_VISOR_REPO
SELECT
...
FROM fila_unica f
LEFT JOIN sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.com_0116_prod existing
...
Archivo Original: com_0116_prod
