...
INSERT INTO `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.list_0001_prod` (
  CODIGO_COMPANIA,
  NUMERO_POLIZA,
  CODIGO_PRODUCTO1,
  FECHA_EMISION,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM `sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.list_0001_prod` t
...
Archivo Original: list_0001_prod
