...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.seg_0004_prod (
    CODIGO_COMPANIA,
    CODIGO_RAMO_EMISION,
    NOMBRE_RAMO_EMISION,
    CODIGO_PRODUCTO,
...
WITH RankedRows AS (
    ...
    WHERE 
        ...
        --AND  a.KEY_ID_TOMADOR != "860034313"
        --AND a.CODIGO_RAMO_EMISION not in (10, 12, 18, 20, 22, 23, 24, 26, 29, 30, 33, 34, 42, 66, 69, 70, 118, 310)
)
...
WHERE 
    ...
    AND NOT EXISTS (
        SELECT 1
        FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.seg_0004_prod existing
...
Archivo Original: seg_0004_prod
