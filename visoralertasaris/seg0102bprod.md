...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.seg_0102B_prod 
(
...
WITH SiniestrosConFila AS (
    ...
    WHERE 
        DATE(FECHA_SINIESTRO) >= '2026-03-01'  -- Solo siniestros desde 2025
        ...
        and CODIGO_RAMO_EMISION NOT IN (70,27)
...
WHERE 
    ...
    AND NOT EXISTS (
        SELECT 1
        FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.seg_0102B_prod t
        WHERE t.KEY_ID_TOMADOR = SiniestrosConFila.KEY_ID_TOMADOR
          AND t.NUMERO_POLIZA = SiniestrosConFila.NUMERO_POLIZA
          AND t.ESTADO_SINIESTRO = SiniestrosConFila.ESTADO_SINIESTRO
    );
...
Archivo Original: seg_0102B_prod
