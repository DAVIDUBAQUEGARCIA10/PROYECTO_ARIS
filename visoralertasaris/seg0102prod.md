...
INSERT INTO sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.SEG_0102_prod (
    CODIGO_COMPANIA,
    NUMERO_POLIZA,
...
WHERE rn = 1
  AND NOT EXISTS (
    SELECT 1
    FROM sb-ecosistemaanalitico-lago.cumplimiento_normativo_prod.SEG_0102_prod t
...
Archivo Original: seg_0102_prod
